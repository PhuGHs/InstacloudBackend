...
import { Recommendation } from '@user/controllers/recommend-users';
...
class UserRoutes {
  ...
  public routes(): Router {
    ...
    this.router.get('/user-recommendation', authMiddleware.checkAuthentication, Recommendation.prototype.users);
    return this.router;
  }
}
